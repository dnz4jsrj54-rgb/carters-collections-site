...
window.CARTER_CATALOG = {
  ...
  m26: { id: 'm26', name: "CEO Man", subtitle: 'by Bella Vita Luxury', cat: 'fragrance', section: 'Men\u2019s Fragrance', notes: "Lemon · Sugar · Lavender · Vetiver", price: 23.99, image: 'assets/real-products/m26_1.jpg', imageFit: 'contain', badge: 'New Arrival', detail: 'product-bella-vita-luxury-ceo-man.html', real: true },
  m27: { id: 'm27', name: "G.O.A.T. Man", subtitle: 'by Bella Vita Luxury', cat: 'fragrance', section: 'Men\u2019s Fragrance', notes: "Bergamot · Lavender · Pepper · Vetiver", price: 23.99, image: 'assets/real-products/m27_1.jpg', imageFit: 'contain', badge: 'New Arrival', detail: 'product-bella-vita-luxury-goat-man.html', real: true },
  ...
  try {
    if (typeof fbq === 'function') {
      ...
      fbq('track', 'AddToCart', {
        ...
        content_name: p.name || productId,
        content_category: p.cat || 'fragrance',
