...
window.CARTER_CATALOG = {
  ...
  b14: { id: 'b14', name: 'Tanala Woven Clutch', subtitle: 'by Ibeliv', cat: 'bag', section: 'Women’s Handbags', notes: 'Hand-Woven Raffia · Orange · Clutch', price: 114.99, oldPrice: 180, image: 'assets/real-products/b14_1.jpg', imageFit: 'contain', badge: 'New Arrival', detail: 'product-ibeliv-tanala-woven-clutch.html', real: true },
  ...
  b21: { id: 'b21', name: 'Snip Leather Shoulder Bag', subtitle: 'by Burberry', cat: 'bag', section: 'Women’s Handbags', notes: 'Grained Leather · Adjustable Strap', price: 1012.99, oldPrice: 2457, image: 'assets/real-products/b21_1.jpg', imageFit: 'contain', badge: '59% Below Retail', detail: 'product-burberry-snip-leather-shoulder-bag.html', real: true },
  b22: { id: 'b22', name: 'Medium Knight Shoulder Bag', subtitle: 'by Burberry', cat: 'bag', section: 'Women’s Handbags', notes: 'Leather · Equestrian Knight Hardware', price: 1142.99, oldPrice: 3090, image: 'assets/real-products/b22_1.jpg', imageFit: 'contain', badge: '63% Below Retail', detail: 'product-burberry-medium-knight-shoulder-bag.html', real: true },
  b23: { id: 'b23', name: 'Check Compact Messenger', subtitle: 'by Burberry', cat: 'bag', section: 'Men’s Bags', notes: 'Check Canvas · Birch Brown · Messenger', price: 722.99, oldPrice: 1250, image: 'assets/real-products/b23_1.jpg', imageFit: 'contain', badge: '', detail: 'product-burberry-check-compact-messenger.html', real: true },
  b24: { id: 'b24', name: 'Denny Slim Shopper', subtitle: 'by Burberry', cat: 'bag', section: 'Men’s Bags', notes: 'Coated Canvas · Charcoal · Slim Shopper', price: 867.99, oldPrice: 1790, image: 'assets/real-products/b24_1.jpg', imageFit: 'contain', badge: '52% Below Retail', detail: 'product-burberry-denny-slim-shopper.html', real: true },
  b25: { id: 'b25', name: 'Origami Colorblock Coin Wallet', subtitle: 'by Coach', cat: 'bag', section: 'Wallets & Small Leather Goods', notes: 'Leather · Colorblock · Zip Coin Wallet', price: 144.99, oldPrice: 250, image: 'assets/real-products/b25_1.jpg', imageFit: 'contain', badge: 'New Arrival', detail: 'product-coach-origami-colorblock-coin-wallet.html', real: true },
  ...
  b28: { id: 'b28', name: 'Shield Coin Pouch', subtitle: 'by Burberry', cat: 'bag', section: 'Wallets & Small Leather Goods', notes: 'Leather · Equestrian Knight · Coin Pouch', price: 272.99, oldPrice: 480, image: 'assets/real-products/b28_1.jpg', imageFit: 'contain', badge: '', detail: 'product-burberry-shield-coin-pouch.html', real: true },
  ...
  b30: { id: 'b30', name: 'Heritage Large Zip Wallet', subtitle: 'by Burberry', cat: 'bag', section: 'Wallets & Small Leather Goods', notes: 'Leather · Zip-Around Wallet', price: 359.99, oldPrice: 760, image: 'assets/real-products/b30_1.jpg', imageFit: 'contain', badge: '53% Below Retail', detail: 'product-burberry-heritage-large-zip-wallet.html', real: true },
  b31: { id: 'b31', name: 'Check Leather Long Wallet', subtitle: 'by Burberry', cat: 'bag', section: 'Wallets & Small Leather Goods', notes: 'Check Canvas + Leather · Long Wallet', price: 432.99, oldPrice: 720, image: 'assets/real-products/b31_1.jpg', imageFit: 'contain', badge: '', detail: 'product-burberry-check-leather-long-wallet.html', real: true },
